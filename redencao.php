...
<section>
    ...
    <div id="player_original">
        <audio id="music" src="http://198.24.156.115:9310/;" preload="true" autoplay controls></audio>
    </div>
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <div class="squares">
                        <ul>
                            ...
                            <li class="hidden-xs hidden-sm"><a href="redencao.php" style="color: #d25246">Redenção</a></li>
