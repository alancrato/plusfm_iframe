...
<section>
    ...
    <div id="player_original">
        <audio id="music" src="http://198.24.156.115:9316/;" preload="true" autoplay controls></audio>
    </div>
                ...
                <div class="col-md-10 col-sm-10 col-xs-10">
                    <div class="squares">
                        <ul>
                            ...
                            <li><a href="aracati.php">Aracati</a></li>
                            ...
                            <li class="hidden-xs hidden-sm"><a href="santa-quiteria.php" style="color: #d25246">St° Quitéria</a></li>
